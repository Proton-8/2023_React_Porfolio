...
export const Services = () => {
  return (
    <div className="">
      <div>
        <h1 className="tag">My Services</h1>
      </div>
      ...
      <div className="Service_Section  background-trans-70">
        ...
        <div className="sections">
          ...
          >
            {/* var Test123  href="https://docs.google.com/document/d/1MfuMqFuQyG7wiIdfwsF5YPtcSD7_MPf1/edit?usp=sharing&ouid=115475312727942649219&rtpof=true&sd=true" target={"_blank"}>My Info</a> */}{" "}
            <button>
              <h3> My Resume </h3>
            </button>
          </a>
